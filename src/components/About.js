                ...
                <hr className="border-white mb-8" />
                    ...
                    >
                        <Slider {...settings}>
                            ...
                            >
                                <img src={jobop} className='h-96 w-full object-cover mb-4 rounded-lg shadow-lg' alt="Job Opportunities" />
                            ...
                            <motion.div
                                ...
                                transition={{ duration: 0.3 }}
                            >
                                <img src={eve} className='h-96 w-full object-cover mb-4 rounded-lg shadow-lg' alt="Events" />
                            ...
                            <motion.div
                                ...
                                transition={{ duration: 0.3 }}
                            >
                                <img src={uni} className='h-96 w-full object-cover mb-4 rounded-lg shadow-lg' alt="Universities" />
                            ...
                            <motion.div
                                ...
                                transition={{ duration: 0.3 }}
                            >
                                <img src={accom} className='h-96 w-full object-cover mb-4 rounded-lg shadow-lg' alt="Accommodation" />
                            ...
                            <motion.div
                                ...
                                transition={{ duration: 0.3 }}
                            >
                                <img src={mentor} className='h-96 w-full object-cover mb-4 rounded-lg shadow-lg' alt="Mentorship" />
